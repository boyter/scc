...
var languageDatabase = map[string]Language{
	...
	"C++ Header": {
		...
		Heuristics: []Heuristic{
			{
				Pattern: "(?m)^\\s*#\\s*include <(cstdint|string|vector|map|list|array|bitset|queue|stack|forward_list|unordered_map|unordered_set|(i|o|io)stream)>",
				Literals: []string{
					"<cstdint>",
					"<string>",
					"<vector>",
			...
			{
				Pattern: "(?m)^[ \\t]*(class|(using[ \\t]+)?namespace)\\s+\\w+",
				Literals: []string{
					"class",
					"namespace",
					"using",
			...
			{
				Pattern: "(?m)^[ \\t]*(private|public|protected):$",
				Literals: []string{
					"private",
					"public",
					"protected",
			...
			{
				Pattern: "__has_cpp_attribute|__cplusplus >",
				Literals: []string{
					"__has_cpp_attribute",
					"__cplusplus",
				},
	...
	"Objective C": {
		...
		Heuristics: []Heuristic{
			{
				Pattern: "(?m)^\\s*(@(interface|class|protocol|property|end|synchronised|selector|implementation)\\b|#import\\s+.+\\.h[\">])",
				Literals: []string{
					"@interface",
					"@class",
					"@protocol",

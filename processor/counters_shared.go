...
func counterSpecs() []counterSpec {
	...
	return []counterSpec{
		...
		{
			Language:         "Assembly",
			Count:            countLoopAssembly,
			Extension:        ".s",
			Anchors:          asmComplexityAnchors,
			LineComments:     []string{";"},
			BlockComments:    cBlocks,
			Quotes:           []string{`"`, `"`, `'`, `'`},
			Stop:             &asmStop,
			StopNoComplexity: &asmStopNoComplexity,
		},
		{
			Language:         "LLVM IR",
			Count:            countLoopLLVMIR,
			Extension:        ".ll",
			Anchors:          llvmComplexityAnchors,
			LineComments:     []string{";"},
			BlockComments:    nil,
			Quotes:           []string{`"`, `"`},
			Stop:             &llvmStop,
			StopNoComplexity: &llvmStopNoComplexity,
		},
		{
			Language:         "Swift",

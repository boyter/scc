...
//func TestIssueVerbatimStringPython(t *testing.T) {
//	ProcessConstants()
//	fileJob := FileJob{
//		Language: "Python",
//	}
//
//	fileJob.SetContent(`r"xyz\\"
//# hi`)
//	fileJob.Bytes = int64(len(fileJob.Content))
//
//	CountStats(&fileJob)
...
//}
//
//func TestIssueVerbatimStringCplusPlus(t *testing.T) {
//	ProcessConstants()
//	fileJob := FileJob{
//		Language: "C++",
//	}
//
//	fileJob.SetContent(`/* 46 lines 37 code 3 comments 6 blanks */
//
//#include <stdio.h>
//
...
//
//	if fileJob.Lines != 46 {
//		t.Errorf("Expected 46 lines")
//	}
//
//	if fileJob.Code != 37 {
//		t.Errorf("Expected 37 lines got %d", fileJob.Code)
//	}
//
//	if fileJob.Comment != 3 {
//		t.Errorf("Expected 3 lines got %d", fileJob.Comment)
...
//
//	if fileJob.Blank != 6 {
//		t.Errorf("Expected 6 lines got %d", fileJob.Blank)
//	}
//}
